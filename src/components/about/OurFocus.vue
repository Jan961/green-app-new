<template>
  <v-container class="focus-section py-12">
    <h2 class="section-title mb-6">Our focus</h2>
...
import baskets from '@/assets/images/about/focus-summary/baskets.png'
...
.focus-card {
  ...
  overflow: hidden;
  height: 420px;
  transition: transform 1.4s cubic-bezier(0.22, 1, 0.36, 1), box-shadow 1s ease;
...
.card-extra {
  ...
  overflow: hidden;
  opacity: 0;
  transition: max-height 1.4s ease, opacity 0.4s ease-in-out;
}
